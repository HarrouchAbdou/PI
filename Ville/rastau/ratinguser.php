...
form .btn button:hover{
  ...
  <body>
    <nav aria-label="navigation" style="margin-top: 200px">   
  <ul class="pager">
    <li class="previous"><a href="gg.php" title="Précédent" style="color:black;">Revenir vers la page du Restaurant </a></li>
